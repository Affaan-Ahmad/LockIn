      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-2 right-2 flex size-11 items-center justify-center rounded-control text-ink-soft hover:bg-sunken disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0"
          >
